...
ggplot(fiti[measured_claim_per_year < 5], aes(y=pricing_per_year, x=factor(measured_claim_per_year)))+geom_violin()+geom_boxplot(width = 0.2)+geom_smooth(mapping = aes(x=measured_claim_per_year, y=pricing_per_year), method = "lm", col="red", lwd =0.4)+ylim(0,400)
...
ggplot(full_fiti[measured_claim_per_year < 5], aes(y=pricing_per_year, x=factor(measured_claim_per_year)))+geom_violin()+geom_boxplot(width = 0.2)+geom_smooth(mapping = aes(x=measured_claim_per_year, y=pricing_per_year), method = "lm", col="red", lwd =0.4)+ylim(0,400)
